...
O3_PM_combined_wrangled <- 
  ...
  mutate(Month = month(Date)) %>% #parse date column, add year & month separately
...
O3_PM_combined_wrangled_spread <- pivot_wider(O3_PM_combined_wrangled, names_from = AQS_PARAMETER_DESC, values_from = meanAQI)

#11
#find dimensions of new dataset
dim(O3_PM_combined_wrangled_spread) #8976 tows by 9 columns
