...
#finds largest element in vector
max(vector1)

#Create another vector of the integers 10 thru 15
vector4 <- c(10:15)

#combines the vectors
#c( is command to create vector
#output to console bc it is not saved as a variable
c(vector1, vector4)

#multiplies respective elements
vector1 * vector4
...
matrix1[4, 1] #item in row 4, column 1 = 104

matrix1[4,  ] #104 109 114 119

matrix1[ , 3] #111 112 113 114 115

matrix1[c(12, 14)] #112 114

matrix1[c(12:14)] #112 113 114

matrix1[2:4, 1:3] #102 107 112
                  #103 108 113
                  #104 109 114
