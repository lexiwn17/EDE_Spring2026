...
nutrient_data <- 
  read.csv(
    "../Data/Processed/NTL-LTER_Lake_Nutrients_PeterPaul_Processed.csv",
    #path is relative to R file, use .. to get out of Lessons file 
    #Lesosons is where this script is saved
...
#### Define UI ----
#all R scripts are divided into UI and server
#UI is short for user interface, where we create all widgets and renders
