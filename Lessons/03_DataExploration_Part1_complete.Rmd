...
```{r Fixing dates}
# Use `format()` to revert date column back to raw string
USGS.flow.data$datetime <- format(USGS.flow.data$datetime, "%y%m%d")

# Create function to prepend century ("19" or "20") to date string 
# based on the whether the date string is "less than" Dec 26, 2019"
...
# Convert datetime from string to date; now using %Y instead of %y
