...
the_facility_name <- webpage %>% 
  html_nodes("#content :nth-child(3) tr:nth-child(2) :nth-child(2)") %>% 
  #what I scraped is different but still returned Plant 15
  html_text()
the_facility_name

the_facility_type <- webpage 
html_nodes("tr:nth-child(2) .left:nth-child(4)") %>% 
  html_text()
